...
class DefaultController extends Controller
{
    ...
    {
    	$galeria_ppal = $this->getDoctrine()->getRepository('AppBundle:Galeria')->find(1);
    	$galeria_loft = $this->getDoctrine()->getRepository('AppBundle:Galeria')->find(2);
    	$galeria_2amb = $this->getDoctrine()->getRepository('AppBundle:Galeria')->find(3);
    	$galeria_3amb = $this->getDoctrine()->getRepository('AppBundle:Galeria')->find(4);
    	return array('galeria_ppal'=>$galeria_ppal,'galeria_loft'=>$galeria_loft,'galeria_2amb'=>$galeria_2amb,'galeria_3amb'=>$galeria_3amb);
    }
